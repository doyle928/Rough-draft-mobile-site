(function () {
  function slideUp() {
    return {
      link: function ($scope, $element, $attrs) {
        ...
        $("#secImage").parallaxify();
        $("#thirdImage").parallaxify();
        ...
        (function ($, window, document, undefined) {
          ...
          var pluginName = 'parallaxify',
            ...
            defaults = {
              ...
              motionType: 'natural',
              mouseMotionType: 'gaussian',
              inputPriority: 'gyroscope', // define which input device has priority over the other 'mouse' or 'gyroscope'
  ...
  angular.module("App").directive("slideUp", slideUp);
})();